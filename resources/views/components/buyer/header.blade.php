                ...
                <div class="header__col-right col d-flex align-items-center">
                    ...
                    <div class="header__profile dropdown">
                        ...
                        <div class="profile-dropdown dropdown-menu dropdown-menu--right">
                            <a class="profile-dropdown__item dropdown-menu__item" href="{{ route("buyers.profile") }}"
                            ...
                            <a class="profile-dropdown__item dropdown-menu__item" href="{{ route("buyers.logout") }}" tabindex="0">
