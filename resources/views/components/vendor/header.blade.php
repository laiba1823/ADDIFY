                ...
                <div class="header__col-right col d-flex align-items-center">
                    ...
                    <div class="header__profile dropdown">
                        ...
                        <div class="profile-dropdown dropdown-menu dropdown-menu--right">
                            <a class="profile-dropdown__item dropdown-menu__item" href="{{ route("vendors.profile") }}"
                            ...
                            <a class="profile-dropdown__item dropdown-menu__item" href="{{ route("vendors.logout") }}" tabindex="0">
