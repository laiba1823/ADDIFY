...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'AlreadyLoggedVendor' => \App\Http\Middleware\AlreadyLoggedVendor::class,
        'AuthCheckVendor' => \App\Http\Middleware\AuthCheckVendor::class,

        'AlreadyLoggedBuyer' => \App\Http\Middleware\AlreadyLoggedBuyer::class,
        'AuthCheckBuyer' => \App\Http\Middleware\AuthCheckBuyer::class,
        'PassBuyerData' => \App\Http\Middleware\PassBuyerData::class,
